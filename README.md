...
- 한국어·대만 번체·중국 대륙 간체 UI와 언어별 기본 감각 단어 15개
- 차 느낌 기록: 제목, 감각 단어, 메모, 우림 기록
- 텍스트 복사와 차 느낌 카드 이미지 저장·공유
- 차별 우림 시간 보정과 브라우저 내 설정 저장
- 오프라인 타이머와 차 느낌 카드 작성·이미지 저장
- 공지사항, 제작자 의견함과 응원의 박수
- 설치 가능한 모바일 PWA 구조
